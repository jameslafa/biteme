...
const CHANGELOG = [
  { id: 20, date: '2026-03-01', text: 'Meal Plan — pick a main recipe and let the app suggest a full week of dishes that share ingredients, then add everything to your shopping list in one go' },
